...
@interface WordAssociationObject : KrollCoverageObject {
#else
@interface WordAssociationObject : KrollObject {
#endif
@private
...
extern NSString * WordAssociation$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	WordAssociationObject *_wordassociation;
	BOOL shutdown;
