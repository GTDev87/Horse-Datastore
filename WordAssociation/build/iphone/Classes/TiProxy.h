...
//Rare exceptions to indicate a bug in the _wordassociation code (Eg, function that a subclass should have implemented)
...
/**
 The base class for WordAssociation proxies.
 */
