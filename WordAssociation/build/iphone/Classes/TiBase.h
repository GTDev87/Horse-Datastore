...
// in simulator we redefine to format for WordAssociation Developer console
...
{\
	NSString * exceptionName = [@"org.wordassociation." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wordassociation";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIWordAssociationNativeItemNone = -1, 
	UIWordAssociationNativeItemSpinner = -2,
	UIWordAssociationNativeItemProgressBar = -3,
	
	UIWordAssociationNativeItemSlider = -4,
	UIWordAssociationNativeItemSwitch = -5,
	UIWordAssociationNativeItemMultiButton = -6,
	UIWordAssociationNativeItemSegmented = -7,
	
	UIWordAssociationNativeItemTextView = -8,
	UIWordAssociationNativeItemTextField = -9,
	UIWordAssociationNativeItemSearchBar = -10,
	
	UIWordAssociationNativeItemPicker = -11,
	UIWordAssociationNativeItemDatePicker = -12,
	
	UIWordAssociationNativeItemInfoLight = -13,
	UIWordAssociationNativeItemInfoDark = -14,
	
	UIWordAssociationNativeItemDisclosure = -15,
	
	UIWordAssociationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WordAssociation instances of
