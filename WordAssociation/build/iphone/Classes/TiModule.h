...
/**
 The base class for all WordAssociation modules
 */
...
/**
 WordAssociation Platform calls this method on startup.
 */
-(void)startup;

/**
 WordAssociation Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 WordAssociation Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 WordAssociation Platform calls this method on resume.
 @param sender The sender of the event.
 */
