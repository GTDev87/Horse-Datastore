 ...
 * Copyright (c) 2009-2011 by WordAssociation, Inc. All Rights Reserved.
...
//@interface WordAssociationObject : NSObject
//@end

@interface WordAssociationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WordAssociationObject class]])
		{
			for (NSString *key in [[(WordAssociationObject*)o modules] allKeys])
			{
